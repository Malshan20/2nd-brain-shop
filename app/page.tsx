...
import { Star, Check, BookOpen, Target } from "lucide-react"
    ...
    <div className="min-h-screen bg-rose-100 dark:bg-gray-900 transition-colors">
      ...
      <header className="border-b border-green-100 dark:border-green-900">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <Link href="https://www.2nd-brain.app" target="_blank" className="text-green-600 dark:text-green-400 text-sm mb-4 block items-center gap-1">
